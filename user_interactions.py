...
class UserInteractions:
    ...
    """ function to as if user would like to add a review and then ask if they want to add a star rating """
...
#                 break
#             try:
#                 self.internal_api.delete_from_read_list(book_to_delete)
#                 print(f"{book_to_delete} has been deleted.")
#                 break
#             except BookNotFound:
#                 print(f"{book_to_delete} is not in your to-read list. Please try again.")
